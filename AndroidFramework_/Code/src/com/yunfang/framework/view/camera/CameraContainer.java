...
public class CameraContainer extends RelativeLayout implements CameraOperation {
	...
	public boolean hasSystematically(){
		return !mCameraView.isUnsystematically();
	}
	...
	public Bitmap stopRecord() {
		...
		if (thumbnailBitmap != null) {
			...
			mTempImageView.startAnimation(R.anim.camera_tempview_show);
		}
	...
	private final PictureCallback pictureCallback = new PictureCallback() {
		...
		public void onPictureTaken(byte[] data, Camera camera) {			
			...
			camera.startPreview();
			if (mListener != null) {
				mListener.onTakePictureEnd(data);
			}
			data = null;
		}
	};
