package com.yunfang.eias.beta.ui.Adapter;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		try {
			if (convertView == null) {
				...
				//任务备注
				holder.item_relat_task_remark=(RelativeLayout)view.findViewById(R.id.item_relat_task_remark);
				holder.item_remark_tv=(TextView)view.findViewById(R.id.item_remark_tv);
				//暂停备注
				holder.item_pause_task_remark=(RelativeLayout)view.findViewById(R.id.item_pause_task_remark);
				holder.item_pauseremark_tv=(TextView)view.findViewById(R.id.item_pauseremark_tv);
			...
			if(holder.item_pause_task_remark!=null){
				if(item.Status == TaskStatus.Pause&&!StringUtil.IsNullOrEmpty(item.Remark)){
