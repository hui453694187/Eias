...
import com.yunfang.eias.beta.dto.TaskCategoryInfoByTypeDTO;
...
import com.yunfang.eias.beta.enumObj.UrgentStatusEnum;
...
public class TaskDataWorker {
	 ...
	 * @return
	 */
	public static ResultInfo<ArrayList<TaskCategoryInfoByTypeDTO>> getTaskCatgoryInfoAndItem(String taskNum, Integer taskID) {
		...
		for (TaskCategoryInfo taskCateInfo : taskInfo.Data.Categories) {
			// 获取当前分类项的，分类配置
			ResultInfo<DataCategoryDefine> cateDefin = DataDefineWorker.getDataCategoryDefineByCategoryId(taskCateInfo.CategoryID);
	...
	public static ResultInfo<ArrayList<TaskDataItem>> queryTaskDataItemsByID(int taskID, int categoryID, int baseCategoryID, Boolean isGetAllTaskDataItemByTaskId) {
		...
		try {
			...
			if (isGetAllTaskDataItemByTaskId) {
				...
				// null, null, null);
				cursor = db.query(taskDataItem.getTableName(), null, "TaskID=? AND CategoryID=?", new String[] { String.valueOf(taskID), String.valueOf(categoryID) }, null, null, null);
				/*
	 ...
	 * @return
	 */
	public static ResultInfo<ArrayList<TaskDataItem>> queryTaskDataItemsBybaseCategoryID(int taskID, int categoryID, int baseCategoryID, Boolean isGetAllTaskDataItemByTaskId) {
		ResultInfo<ArrayList<TaskDataItem>> resultInfo = new ResultInfo<ArrayList<TaskDataItem>>();
		ArrayList<TaskDataItem> data = null;
		TaskDataItem taskDataItem = null;
		SQLiteDatabase db = null;
	...
	private static ArrayList<TaskCategoryInfo> getCompleteTaskCategories(Integer taskID, Boolean isCreateByUser) {
		...
		if (cursor != null) {
			while (cursor.moveToNext()) {
				...
				ResultInfo<ArrayList<TaskDataItem>> resultInfo = queryTaskDataItemsBybaseCategoryID(taskId, categoryId, baseCategoryId, false);
	 ...
	 *            :服务器是否有保存成功
	 */
	public static synchronized ResultInfo<Boolean> submitedUpdateTaskInfo(TaskInfoDTO taskDto, Boolean isSuccess) {
		ResultInfo<Boolean> result = new ResultInfo<Boolean>();
		SQLiteDatabase db = null;
