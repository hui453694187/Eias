...
import com.yunfang.eias.beta.dto.VersionDTO;
import com.yunfang.eias.beta.http.task.OnlineLoginTask;
...
public class LoginInfoOperator {
	...
	private static void saveToLocalVersionInfo(VersionDTO versionDto) {
		...
		sp.putString(KEY_LASTVERSIONINFO,
				JSONHelper.toJSON(EIASApplication.versionInfo));
	}
