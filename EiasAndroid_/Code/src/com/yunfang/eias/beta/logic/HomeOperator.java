...
import com.yunfang.eias.beta.http.task.CheckVersionTask;
import com.yunfang.eias.beta.http.task.GetDataDefineDataTask;
import com.yunfang.eias.beta.http.task.GetFinishInworkReportTask;
import com.yunfang.eias.beta.http.task.GetHomeInfoTask;
import com.yunfang.eias.beta.http.task.GetReturnTask;
...
public class HomeOperator {
	...
	private static void checkoutVersion() {
		...
		ResultInfo<VersionDTO> checkResult = taskHttp.request(EIASApplication
				.getCurrentUser());
		if (checkResult.Success && checkResult.Data != null) {// 有新版本需要更新
			UserInfoOperator.setVersionInfo(checkResult.Data);
		}
