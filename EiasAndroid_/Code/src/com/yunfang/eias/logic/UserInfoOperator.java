...
public class UserInfoOperator {
	 ...
	 * @return 图像字符串
	 */
	public static String getImageStr(Bitmap image) {
		// 获得图片字符串
	 ...
	 * @param loginEasyInfo:服务器版本信息对象
	 */
	public static void setVersionInfo(LoginEasyDto dto){
		...
		sp.putString(LoginInfoOperator.KEY_LASTVERSIONINFO,JSONHelper.toJSON(EIASApplication.loginEasy));
	}
}
