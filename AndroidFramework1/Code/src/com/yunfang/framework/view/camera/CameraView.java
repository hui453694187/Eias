package com.yunfang.framework.view.camera;
...
public class CameraView extends SurfaceView implements CameraOperation {
	...
	/** 是否没有权限调用系统相机 */
	private boolean unSystematically = false;
	...
	private SurfaceHolder.Callback callback = new SurfaceHolder.Callback() {
		...
		public void surfaceCreated(SurfaceHolder holder) {
			try {
				...
				/** 打开相机失败， 判断没有权限 */
				setUnsystematically(true);
				Toast.makeText(getContext(), "打开相机失败,切换到系统自带相机，或者查看是否相机权限被禁止。",
	...
	public boolean startRecord() {
		...
		if (!directory.exists())
			directory.mkdirs();
		try {
			String name = "video" + FileOperateUtil.createFileNameUUID(".3gp");
	...
	public int getMaxZoom() {
		...
		try {
			/**
			 * 2015-11-20 测试魅族手机，在禁用摄像头调用权限后，打开摄像头没抛出异常，导致继续跑到这里的时候抛出异常
			 * */
	...
	/**
	 */
	public boolean isUnsystematically() {
		return unSystematically || mCamera == null;
	}

	/**
	 */
	public void setUnsystematically(boolean unsystematically) {
		this.unSystematically = unsystematically;
	}
}